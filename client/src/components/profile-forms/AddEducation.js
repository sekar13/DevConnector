    ...
    <Fragment>
      ...
      <form className="form" onSubmit={e => {
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          <p><input type="checkbox" name="current" checked={current}  value={current} onChange={e => {setFormData({...formData,current:!current});toggleDisabled(!toDateDisable)}} />{ ' '} Current School</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
